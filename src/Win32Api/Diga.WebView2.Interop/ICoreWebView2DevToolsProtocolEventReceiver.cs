...
namespace Diga.WebView2.Interop
{
  ...
  public partial interface ICoreWebView2DevToolsProtocolEventReceiver
  {
    ...
    void add_DevToolsProtocolEventReceived(
      [MarshalAs(UnmanagedType.Interface)] ICoreWebView2DevToolsProtocolEventReceivedEventHandler handler,
      out EventRegistrationToken token);

    //[MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
    void remove_DevToolsProtocolEventReceived( EventRegistrationToken token);
  }
}
