...
{
    public class CoreWebView2WebMessageReceivedEventArgsShim : EventArgs, IDisposable
    {
        ...
        public CoreWebView2WebMessageReceivedEventArgsShim(ICoreWebView2WebMessageReceivedEventArgs iface)
        {
        ...
        private ICoreWebView2WebMessageReceivedEventArgs Iface
        {
            get
            {
                if (_Iface == null)
                {
                    Debug.Print(nameof(CoreWebView2WebMessageReceivedEventArgsShim) + "=>" + nameof(Iface) + " is null");

                    throw new InvalidOperationException(nameof(CoreWebView2WebMessageReceivedEventArgsShim) + "=>" + nameof(Iface) + " is null");
                }
