...
namespace Diga.WebView2.Wrapper.shim
{
    ...
    public class CoreWebView2_2Shim : CoreWebView2Shim
    {
        ...
        private ICoreWebView2_2 WebView
        {
            get
            {
                ...
                {
                    Debug.Print(nameof(CoreWebView2_2Shim) + "." + nameof(this.WebView) + " is null");
                    throw new InvalidOperationException(nameof(CoreWebView2_2Shim) + "." + nameof(this.WebView) + " is null");
        ...
        [EditorBrowsable(EditorBrowsableState.Never)]
        public CoreWebView2_2Shim(ICoreWebView2_2 webView) : base(webView)
        {
            if (webView == null)
