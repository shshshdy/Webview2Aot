...
{
    public class CoreWebView2ControllerShim : IDisposable
    {
        ...
        public CoreWebView2ControllerShim(ICoreWebView2Controller controller)
        {
        ...
        private ICoreWebView2Controller Controller
        {
            get
            {
                if (_Controller == null)
                {
                    Debug.Print(nameof(CoreWebView2ControllerShim) + "Controller is null");
